...
class BookDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Glide.with(requireContext()).load(arguments?.getString("imageUrl")).into(binding.imgBook)
        ...
        val chapterAdapter = ChapterAdapter(emptyList()) { chapter ->
            ...
            findNavController().navigate(R.id.action_bookDetailFragment_to_chapterReaderFragment, bundle)
        }
        ...
        binding.btnContinueReading.setOnClickListener {
            val chapterVm = ViewModelProvider(this)[ChapterViewModel::class.java]
            val lastOrder = chapterVm.getLastReadOrder(bookId)
            val bundle = Bundle().apply {
